...
public class Status extends AsyncTask<MainActivity, Void, String> {
	MainActivity c;
	// A method that runs on the background thread and performs the network operation
	@Override
	public String doInBackground(MainActivity... params) {
	...
	protected void onPostExecute(String result) {
		...
		if (result != null) {
			...
			try {
				...
				int dinarDiss = jsonObject.getInt("dinarDiss");
//				int participatingUsers = jsonObject.getInt("participatingUsers");
//				int participatingUsers = jsonObject.getInt("participatingUsers");
